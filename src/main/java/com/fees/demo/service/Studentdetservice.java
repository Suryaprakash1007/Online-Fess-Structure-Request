...
public class Studentdetservice {
	...
	public Studentdetailmodel saveStudent(String rollno, String name, String reason, String email,String course, String department, String year,
	...
	public List<Request> getRequestsByRollno(String rollno) {
